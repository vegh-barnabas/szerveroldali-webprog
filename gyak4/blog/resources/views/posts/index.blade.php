    ...
    <div class="row justify-content-between">
        ...
        <div class="col-12 col-md-4">
            <div class="float-lg-end">
                ...
                <a href="{{ route('new-post') }}" role="button" class="btn btn-sm btn-success mb-1"><i class="fas fa-plus-circle"></i> Create post</a>

                <a href="{{ route('new-category') }}" role="button" class="btn btn-sm btn-success mb-1"><i class="fas fa-plus-circle"></i> Create category</a>
